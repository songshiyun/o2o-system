...
public class ShopAdminController {
	...
	@RequestMapping(value = "/awardcirclechart", method = RequestMethod.GET)
	private String awardCircleChart() {
		// 店铺用户积分兑换路由
		return "shop/awardcirclechart";
	}
	//step line统计图
	@RequestMapping(value = "/awardsteplinechar", method = RequestMethod.GET)
	private String awardsteplinechar() {
		// 店铺用户积分兑换路由
		return "shop/awardlinestep";
	}	
	//piedoughnut统计图
	@RequestMapping(value = "/piedoughnut", method = RequestMethod.GET)
	private String pieDoughnut() {
			// 店铺用户积分兑换路由
		return "shop/pie-doughnut";
	}
}
